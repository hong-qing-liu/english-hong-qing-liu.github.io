...
<div class="section">
  ...
  <p>
    My expertise includes search engines, recommender systems, machine learning, reinforcement learning, numerical algorithms, and NLP. When I was in academia, I did research on machine learning, numerical optimization, parallel computing, etc. (Here is a link to my Google Scholar.) In the industry, I have done many projects on recommender systems, search engines, and NLP techniques.
  </p>
</div> 
